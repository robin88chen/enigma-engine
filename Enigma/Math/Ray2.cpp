...
Ray2::Ray2() : m_origin(Point2::ZERO), m_direction(Vector2::UNIT_X)
{
}

Ray2::Ray2(const Point2& origin, const Vector2& direction) : m_origin(origin), m_direction(direction)
{
...
void Ray2::origin(const Point2& origin)
{
    m_origin = origin;
}
